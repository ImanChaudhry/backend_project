...
//    INDEX
    @GetMapping(value = "/{id}")//localhost:8080/accounts
...
//    SHOW
//    @GetMapping(value = "/{isdebit}")//localost:8080/accounts/isdebit=true
//    public ResponseEntity<List<Account>> getAllDebitAccounts(
//            @PathVariable boolean isDebit){
//        return new ResponseEntity<>(accountRepository.findByIsDebit(isDebit), HttpStatus.OK);
//    }
