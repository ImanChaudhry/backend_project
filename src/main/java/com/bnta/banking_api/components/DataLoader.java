...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        // Payment data
        Payment payment1 = new Payment("Amazon", LocalDate.of(2022, 1,2), 9.99, basicAccount1,Category.SHOPPING);
        Payment payment2 = new Payment("Gym", LocalDate.of(2022, 3, 29), 31.99,basicAccount2,Category.HEALTH);
        Payment payment3 = new Payment("Tesco", LocalDate.of(2022, 4, 1),  80.65, jointAccount10,Category.SHOPPING);
        Payment payment4 = new Payment("JD", LocalDate.of(2022, 9, 27),  101.98, basicAccount4,Category.SHOPPING);
        Payment payment5 = new Payment("Lidl", LocalDate.of(2022, 4, 29),  50.02,jointAccount5,Category.SHOPPING);
        Payment payment6 = new Payment("KFC", LocalDate.of(2022, 2, 7),  5.49, basicAccount7,Category.EATING_OUT);
        Payment payment7 = new Payment("Odeon", LocalDate.of(2022, 3, 30),  40.36, basicAccount8,Category.ENTERTAINMENT);
        Payment payment8 = new Payment("Bowling", LocalDate.of(2022, 10, 24), 9.87,basicAccount10,Category.ENTERTAINMENT);
        Payment payment9 = new Payment("Uber", LocalDate.of(2022, 5, 9),  7.99, basicAccount5,Category.TRANSPORT);
        Payment payment10 = new Payment("Ebay", LocalDate.of(2022, 3, 3),  22.60, basicAccount6,Category.SHOPPING);
        Payment payment11 = new Payment("Apple", LocalDate.of(2022, 3, 13),  2080.00,jointAccount9,Category.SHOPPING);
        Payment payment12 = new Payment("John Lewis", LocalDate.of(2022, 3, 13),  501.80,jointAccount7,Category.SHOPPING);
        Payment payment13 = new Payment("Lidl", LocalDate.of(2022, 1, 11),  15.67, jointAccount6,Category.SHOPPING);
        Payment payment14 = new Payment("Nandos", LocalDate.of(2022, 5, 3),  34.45, basicAccount9,Category.EATING_OUT);
        Payment payment15 = new Payment("B&Q", LocalDate.of(2022, 5, 6),  451.99, jointAccount4,Category.OTHER);
        Payment payment16 = new Payment("Costa", LocalDate.of(2022, 4, 3),  2.99,basicAccount3,Category.EATING_OUT);
        Payment payment17 = new Payment("Tesco", LocalDate.of(2022, 3, 6),  43.89, jointAccount7,Category.SHOPPING);
        Payment payment18 = new Payment("Currys", LocalDate.of(2022, 12, 3),  302.34,jointAccount3,Category.SHOPPING);
        Payment payment19 = new Payment("Gym", LocalDate.of(2022, 3, 3),  31.99, jointAccount6,Category.HEALTH);
        Payment payment20 = new Payment("B&M", LocalDate.of(2022, 2, 16),  18.22, jointAccount4,Category.SHOPPING);
        ...
        // Subscription data
        Subscription sub1 = new Subscription("Nandos", LocalDate.of(2016, 12, 14), Category.EATING_OUT, 54.99, true, basicAccount1);
        Subscription sub2 = new Subscription("Thames Water", LocalDate.of(2020, 9, 12), Category.BILLS, 69.99, true, basicAccount3);
        Subscription sub3 = new Subscription("TFL", LocalDate.of(2021, 3, 19), Category.TRANSPORT, 59.99, false, basicAccount2);
        Subscription sub4 = new Subscription("Pure Gym", LocalDate.of(2015, 5, 22), Category.HEALTH, 24.99, true, basicAccount6);
        Subscription sub5 = new Subscription("Soul Cycle", LocalDate.of(2009, 8, 24), Category.HEALTH, 149.99, false, basicAccount7);
        Subscription sub6 = new Subscription("O2", LocalDate.of(2012, 2, 28), Category.BILLS, 14.99, false, basicAccount8);
        Subscription sub7 = new Subscription("Netflix", LocalDate.of(2017, 11, 23), Category.ENTERTAINMENT, 14.99, true, basicAccount9);
        Subscription sub8 = new Subscription("Tesco", LocalDate.of(2019, 10, 30), Category.SHOPPING, 44.99, false, basicAccount10);
        Subscription sub9 = new Subscription("Farah Charity", LocalDate.of(2014, 6, 1), Category.CHARITY, 64.99, true, basicAccount4);
        Subscription sub10 = new Subscription("Easy Jet", LocalDate.of(2013, 4, 13), Category.OTHER, 84.99, true, basicAccount5);
        Subscription sub11 = new Subscription("Tastily prepared meals", LocalDate.of(2017, 7, 30), Category.OTHER, 23.99, true, jointAccount4);
        Subscription sub12 = new Subscription("British Red Cross", LocalDate.of(2016, 4, 13), Category.CHARITY, 34.99, false, jointAccount3);
        Subscription sub13 = new Subscription("Sainsburys", LocalDate.of(2019, 3, 15), Category.SHOPPING, 65.99, false, jointAccount2);
        Subscription sub14 = new Subscription("TFL", LocalDate.of(2015, 5, 12), Category.TRANSPORT, 23.99, true, jointAccount1);
        Subscription sub15 = new Subscription("Spotify", LocalDate.of(2017, 9, 16), Category.ENTERTAINMENT, 4.99, false, jointAccount10);
        Subscription sub16 = new Subscription("Thames Water", LocalDate.of(2020, 12, 2), Category.BILLS, 55.99, true, jointAccount9);
        Subscription sub17 = new Subscription("Pure Gym", LocalDate.of(2021, 10, 23), Category.HEALTH, 12.99, true, jointAccount8);
        Subscription sub18 = new Subscription("Taco Bell", LocalDate.of(2022, 3, 29), Category.EATING_OUT, 42.99, false, jointAccount7);
        Subscription sub19 = new Subscription("National Grid", LocalDate.of(2004, 5, 23), Category.BILLS, 68.99, true, jointAccount6);
        Subscription sub20 = new Subscription("Netflix", LocalDate.of(2019, 2, 8), Category.ENTERTAINMENT, 9.99, true, jointAccount5);
